...
struct RightContentView: View {
    ...
    var body: some View {
        ...
        .onChange(of: currentDirectory) { _ in loadContents() }
    }
    ...
    func loadDirectoryContents(_ url: URL) -> [FileItem] {
        ...
        for url in contents {
            ...
            fileItems.append(FileItem(url: url, name: url.lastPathComponent, isDirectory: isDirectory, isArchive: isArchive, size: size, modificationDate: modDate))
        }
